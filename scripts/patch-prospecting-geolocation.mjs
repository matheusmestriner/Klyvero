...
replaceOnce(
  "        city: targetCity,\n        radiusKm,",
  "        city: targetCity,\n        latitude: geoPoint ? Number(geoPoint.latitude.toFixed(4)) : undefined,\n        longitude: geoPoint ? Number(geoPoint.longitude.toFixed(4)) : undefined,\n        accuracyM: geoPoint?.accuracy,\n        radiusKm,",
  'search coordinates',
);
